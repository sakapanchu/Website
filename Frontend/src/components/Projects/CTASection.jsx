...
export default function CTASection() {
  ...
  return (
    <section ref={sectionRef} className="w-full py-10 px-3 sm:px-6 lg:px-8 bg-[#F1F1F1] overflow-hidden">
      <motion.div
          ...
          <div className="relative z-10 flex flex-col justify-center min-h-[381px] px-6 sm:px-10 lg:px-24 py-12 sm:py-16 lg:py-20">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
              <motion.button
                ...
                className="inline-flex items-center gap-2 px-3 sm:px-6 sm:px-10 py-4 rounded-full border border-[#FFC80B] bg-white/10 text-[#FFC80B] font-bold text-base hover:bg-white/20 transition-all duration-300 hover:scale-105 group"
              >
