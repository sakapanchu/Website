...
export default function ProjectsHero() {
  ...
  return (
    <section ref={sectionRef} className="w-full mt-24 py-10 px-4 sm:px-6 lg:px-8 bg-[#F1F1F1] overflow-hidden">
      <motion.div
        ...
        >
          ...
          <div className="relative z-10 flex flex-col justify-between min-h-[779px] py-12 px-6 sm:px-10 lg:px-16">
            ...
            >
              ...
              {/* Explore Button */}
              <button className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#FFC80B]/20 border border-[#FFC80B] text-white font-bold text-base hover:bg-[#FFC80B]/30 transition-all duration-300 hover:scale-105 group">
