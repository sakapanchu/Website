            ...
            {latestPosts.map((post) => (
              ...
              >
                ...
                <div className="relative h-[220px] overflow-hidden group/img">
                  ...
                  {/* Category Badge */}
                  <span className={`absolute top-4 left-4 inline-block px-3.5 py-1 text-[10px] font-bold tracking-wider rounded-full text-white uppercase shadow-sm ${post.badgeColor}`}>
                    {post.category}
                  </span>
                </div>
