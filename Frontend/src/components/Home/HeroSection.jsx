        ...
        <div className="relative z-10 flex flex-col min-h-[520px] md:min-h-[680px] lg:min-h-[779px]">
          <div className="flex-1 px-8 sm:px-12 lg:px-16 pt-16 sm:pt-20 lg:pt-32 pb-6">
            ...
            >
              ...
              >
                <button className="flex items-center gap-2 px-8 py-3 max-w-[272.5px] max-h-[50px] rounded-full border border-[#FFC80B] bg-[#FFC80B]/20 text-white font-bold text-base leading-6 transition-colors hover:bg-[#FFC80B]/30">
                  Explore Services
                  <svg
                    width="14"
                    height="6"
                ...
                <button className="flex items-center gap-2 px-8 py-3 max-w-[176.88px] max-h-[50px] rounded-full border border-white/20 bg-white/10 text-white font-bold text-base leading-6 transition-colors hover:bg-white/20">
                  Contact us
                  <svg
                    width="17"
                    height="17"
