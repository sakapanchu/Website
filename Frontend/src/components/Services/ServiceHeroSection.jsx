...
import ServiceHeroImage from "../../assets/servicebg.png";
        ...
        <div className="relative z-10 flex flex-col min-h-[520px] md:min-h-[680px] lg:min-h-[779px]">
          <div className="flex-1 px-8 sm:px-12 lg:px-16 pt-16 sm:pt-20 lg:pt-32 pb-6">
            ...
            >
              ...
              <p className="text-white text-base sm:text-lg lg:text-[20px] font-semibold leading-[1.4] lg:leading-[28px] max-w-[600px]">
                We help businesses automate processes, increase efficiency, and
                accelerate growth through AI, cloud computing, web applications,
